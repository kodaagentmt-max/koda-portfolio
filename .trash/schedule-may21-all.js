  ...
  return new Promise((resolve) => {
    const req = https.request(opts, res => {
      ...
      res.on('end', () => {
        ...
        console.log(id ? `✅ Post scheduled: ${id}` : `❌ Failed: ${JSON.stringify(parsed)}`);
        resolve(data);
      });
    });
...
async function main() {
  ...
  // === TIGHT LINES ===
  // 1. Midday Engagement - 12 PM MDT
  console.log('Scheduling Tight Lines midday engagement...');
...
Tight lines, KC`,
  ...
  // 2. Afternoon "What's Working This Week" - 3 PM MDT
  console.log('Scheduling Tight Lines afternoon post...');
  await post(tightLines,
...
Tight lines, KC`,
  ...
  // 3. Evening Hook Line & Thinker - 6 PM MDT
  console.log('Scheduling Tight Lines evening Hook Line & Thinker...');
  await post(tightLines,
    `🧠 HOOK, LINE & THINKER 🧠
...
Tight lines, KC`,
  ...
  console.log('Scheduling Camp Cook midday engagement...');
  await post(campCook,
...
Camp Cook`,
  ...
  // 5. Afternoon Camp Kitchen Hack - 3 PM MDT
  console.log('Scheduling Camp Cook afternoon hack...');
  await post(campCook,
    `🔧 CAMP KITCHEN HACK 🔧
...
Camp Cook`,
  ...
  // 6. Evening Camp Kitchen Hack - 6 PM MDT
  console.log('Scheduling Camp Cook evening hack...');
  await post(campCook,
    `🔧 CAMP KITCHEN HACK 🔧
